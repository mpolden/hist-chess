...
public class getRect {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getRect.getRectCoordX(56));
        System.out.println(getRect.getRectCoordY(56));
    }
